...
class Experience(models.Model):
    ...
    user = models.ForeignKey(TTUser, on_delete=models.CASCADE)


    #TODO: Make model for individual companies. Put many-to-one field in both recruiter and job seeker?
